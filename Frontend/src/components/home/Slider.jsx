...
const CATEGORY_CARDS = [
  {
    id: "snacks",
    category: "Snacks",
    tamilBadge: "மொறுமொறு ஸ்நாக்ஸ்",
    subtitle: "Authentic & Crunchy",
    title: "Crispy Murukku",
    tagline: "Handcrafted with traditional spices",
    btnText: "Order Now",
    image: muruku,
    gradient: "from-[#2A150D] via-[#3D2012] to-[#1F0E07]",
    borderColor: "border-amber-800/30",
    glowColor: "bg-amber-500/20",
    textLight: true,
    accentPill: "text-white font-extrabold tracking-wide drop-shadow-xs",
    btnClass: "bg-gradient-to-r from-amber-500 to-orange-500 text-white hover:from-amber-600 hover:to-orange-600 shadow-lg shadow-amber-950/40",
    colSpan: "lg:col-span-1",
  },
  {
    id: "rava",
    category: "Rava",
    tamilBadge: "சூப்பர் ரவை",
    subtitle: "Golden & Wholesome",
    title: "Traditional Sooji",
    tagline: "Perfect for fluffy upma & kesari",
    btnText: "Explore",
    image: rava,
    ...
    textLight: true,
    accentPill: "text-white font-extrabold tracking-wide drop-shadow-xs",
    btnClass: "bg-white text-amber-900 hover:bg-amber-50 shadow-lg shadow-amber-950/30",
    colSpan: "lg:col-span-1",
  },
  {
    id: "flour",
  ...
  },
  {
    ...
    textLight: true,
    accentPill: "text-white font-extrabold tracking-wide drop-shadow-xs",
    btnClass: "bg-emerald-100 text-emerald-950 hover:bg-white shadow-lg shadow-emerald-950/40",
    colSpan: "lg:col-span-1",
  },
  {
    id: "pickles",
    ...
    gradient: "from-[#831843] via-[#701A75] to-[#4A044E]",
    borderColor: "border-pink-500/30",
    glowColor: "bg-pink-400/20",
    textLight: true,
    accentPill: "text-white font-extrabold tracking-wide drop-shadow-xs",
    btnClass: "bg-white text-[#701A75] hover:bg-pink-50 shadow-lg shadow-pink-950/40",
    colSpan: "lg:col-span-1",
  },
];
