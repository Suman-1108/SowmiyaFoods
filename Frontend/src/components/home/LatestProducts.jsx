...
const LatestProducts = () => {
  ...
  const products = (data?.latestProducts && data.latestProducts.length > 0)
    ? data.latestProducts
    : (cachedData?.products?.slice(0, 10) || []);
      ...
      <section className="py-12 bg-white relative">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="py-12 flex flex-col items-center justify-center">
            ...
            <p className="text-gray-500 font-medium text-xs sm:text-sm">Loading featured products...</p>
          </div>
        </div>
      </section>
    );
        ...
        <div className="relative">
          ...
          >
            {processedProducts.map((product, pIdx) => {
              ...
              const reviewCount = 65 + ((pIdx * 37) % 85);
              ...
              return (
                ...
                >
                  <div className="bg-white rounded-2xl border border-gray-200/85 hover:border-gray-300 shadow-xs hover:shadow-md transition-all duration-300 p-3 sm:p-3.5 flex flex-col justify-between h-full">
                    ...
                    >
                      {/* Top-Left Badge (Sale / Best Seller / New / Out of Stock) */}
                      {badge && (
